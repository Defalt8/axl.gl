...
class AXLGLCXXAPI Texture3D : public Texture
{
	public:
		Texture3D(axl::gl::Context* ptr_context = (axl::gl::Context*)0);
		virtual ~Texture3D();
		Type type() const;
	protected:
		bool icreate();
	...
	public:
		...
		bool allocate(axl::glfl::GLint level, axl::glfl::GLsizei width, axl::glfl::GLsizei height, axl::glfl::GLsizei depth, axl::glfl::GLint internal_format, axl::glfl::GLint border = 0);
		bool setImage(axl::glfl::GLint level, axl::glfl::GLint x_offset, axl::glfl::GLint y_offset, axl::glfl::GLint z_offset, axl::glfl::GLsizei width, axl::glfl::GLsizei height, axl::glfl::GLsizei depth, axl::glfl::GLenum format, axl::glfl::GLenum data_type, const axl::glfl::GLvoid* in_image_data, axl::glfl::GLint pixel_alignment = 4);
		...
		axl::math::Vec3f getSize(axl::glfl::GLint level = 0) const;
};
